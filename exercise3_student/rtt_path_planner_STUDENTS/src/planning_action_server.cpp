...
public:
  ...
  void executeCB(const std::shared_ptr<GoalHandle> goal_handle)
  {
    ClearPreviousResult();
    rclcpp::Rate r(4);
    bool no_success = true;     // adapt if needed

    // TASK 2 TODO: format the goal for the planner

    // TASK 2 TODO: use the RRTPlanner to plan
    // Hint: uncomment beblow to create planner:
    // RRTPlanner planner(start, end);

    if(no_success)
    {

      // TASK 2 TODO: handle no path found
      
    }

    // TASK 2 TODO: publish feedback at each step
    // HINT: please use the given looprate r

    // TASK 2 TODO: send result
